...
Partial Public Class frmYeniMiktarIlerlet_2
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtKutudakiMiktar.TabIndex = 8
        '
        'frmYeniMiktarIlerlet
        '
