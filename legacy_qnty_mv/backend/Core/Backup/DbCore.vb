...
#Region " Functions -> RunSp "
        ...
        'Return     :returnValue
        '*******************************************************************************
        Protected Function RunSp(ByVal sProcName As String, _
        ...
        'Return     :
        '*******************************************************************************
        Protected Sub RunSp(ByVal sProcName As String, _
                    ByVal parameter As ArrayList, _
        ...
        'Return     :Object
        '*******************************************************************************
        Protected Function RunSp(ByVal sProcName As String) As Object
            '
            Dim cmd As New SqlCommand
            '
...
#Region " Functions -> RunQuery "
        ...
        'Return     :ds: dataset
        '*******************************************************************************
        Protected Function RunSql(ByVal sSql As String, _
                    ByVal sTableName As String) As DataSet
        ...
        'Return     :dt: dataTable
        '*******************************************************************************
        Protected Function RunSql(ByVal sSql As String) As DataTable
        ...
        'Return     :object
        '*******************************************************************************
        Protected Function RunSql(ByVal sSql As String, ByVal Scalar As Boolean) As Object
            '
